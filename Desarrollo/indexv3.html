			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="index.html"><img src="logo/logo.png"  alt="company logo here"></a></strong >  
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="tg-themetabs tg-themetabsvtwo">
								<ul class="tg-themetabnav" role="tablist">
									...
									<li role="presentation"><a href="#africa" aria-controls="africa" role="tab" data-toggle="tab"><strong>Arequipa</strong></a></li>
									<li role="presentation"><a href="#asia" aria-controls="asia" role="tab" data-toggle="tab"><strong>Cajamarca</strong></a></li>
					...
					<div class="row">
						<div class="tg-ourdestination">
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 tg-verticalmiddle">
								<figure><img src="images/placeholder/mapa del peru.png" alt="image destinations"></figure>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 tg-verticalmiddle">
