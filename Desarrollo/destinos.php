...
<body>
	...
	<nav id="menu">
		<ul>
			...
			<li><a href="destinations.html">Inicio</a>
			</li>
					...
					<div class="tg-topbar">
						<nav class="tg-infonav">
							<ul>
								<li>
									...
									<i><img src="src/images/icons/icon-01.png" alt="image destinations"></i>
									<span>555-5555</span>
								</li>
								<li>
									<i><img src="src/images/icons/icon-02.png" alt="image destinations"></i>
									<span>ELIGE TU EXPERIENCIA <a href="javascript:void(0);">Descubre mas</a></span>
						...
						<div class="tg-addnavcartsearch">
							...
							<nav class="tg-cartsearch">
								<ul>
									<li>
										<a href="javascript:void(0);"><img src="src/images/icons/icon-03.png" alt="image destinations"></a>
									</li>
									<li><a href="#tg-search"><img src="src/images/icons/icon-04.png" alt="image destinations"></a></li>
								</ul>
							</nav>
						</div>
					</div>
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="indexv3.html"><img src="logo/LogoV2.png" alt="company logo here"></a></strong>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>Destinos</h1>
							<h2>Explora los Mejores Tours en Nuestra Página</h2>
							<ol class="tg-breadcrumb">
								<li><a href="indexv3.html">Inicio</a></li>
								<li class="tg-active">Destinos</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="tg-topdestinations">
								<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												...
												<a href="listingvone.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvone.html"><img src="images/tours/Portalm2.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvone.html">Lima</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
									</div>
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="listingvtwo.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvtwo.html"><img src="images/tours/Portal_102809375_machu.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvtwo.html">Cuzco</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="listingvthree.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvthree.html"><img src="images/tours/PortalIglesia-de-San-Francisco.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvthree.html">Cajamarca</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="listingvfour.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvfour.html"><img src="images/tours/Portalfoto-2-3.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvfour.html">Arequipa</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="listingvfive.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvfive.html"><img src="images/tours/Portal24-imagen-1427552822018.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvfive.html">Ancash</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="listingvsix.html" class="tg-btnviewall">Ver todas las Rutas</a>
												<a href="listingvsix.html"><img src="images/tours/Portal11252_11.png" alt="image description"></a>
												<figcaption>
													<h2><a href="listingvsix.html">Trujillo</a></h2>
													<span class="tg-totaltours"># de Rutas</span>
												</figcaption>
											</figure>
										</div>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgettext">
								...
								<div class="tg-widgetcontent">
									...
									<a href="mailto:info@travlu.com">viaje.seguro@unmsm.edu.pe</a>
									...
									<ul>
										<li>
											...
											<div class="tg-newcontent">
												<h4><a href="javascript:void(0);">Lima, Ciudad de Caral</a></h4>
												<div class="tg-description">
													<p>Manifestación más antigua de la civilización en el Perú por sus 5000 años de antigüedad</p>
												</div>
												<time datetime="2017-06-06">Feb 22, 2021</time>
											</div>
										</li>
										<li>
											<figure>
											...
											<div class="tg-newcontent">
												<h4><a href="javascript:void(0);">Chan Chan</a></h4>
												<div class="tg-description">
													<p>Compuesta por ciudadelas pequeñas, amplias plazas, terrazas y pirámides truncas</p>
												</div>
												<time datetime="2017-06-06">Feb 22, 2021</time>
											</div>
										</li>
						...
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgetdestinations">
								...
								<div class="tg-widgetcontent">
									<ul>
										<li><a href="javascript:void(0);">Lima, Ciudad de Caral</a></li>
										<li><a href="javascript:void(0);">Cuzco, Macchu Picchu</a></li>
										<li><a href="javascript:void(0);">Cajamarca, San Francisco</a></li>
										<li><a href="javascript:void(0);">Arequipa, Bosque de piedras</a></li>
										<li><a href="javascript:void(0);">Ancash,Chavin de Huantar</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgetnewsletter">
								...
								<div class="tg-widgetcontent">
									...
									<span>Nosotros respetamos su privacidad</span>
								</div>
							</div>
						</div>
					</div>
